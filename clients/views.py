...
from clients.serializers import ClientSerializer, ManagementClientSerializer
from clients.permissions import ClientPermissionList, ClientPermissionObject
from users.permissions import IsSaleSupport, IsManagement
